...
resource "aws_iam_role" "accessible_image_recognition_handler_lambda_role" {
  name = "accessible_image_recognition_handler_lambda_role"
...
resource "aws_iam_role_policy" "dynamodb_access" {
  ...
  role = aws_iam_role.accessible_image_recognition_handler_lambda_role.id
...
resource "aws_iam_role_policy_attachment" "lambda_basic_execution" {
  ...
  role       = aws_iam_role.accessible_image_recognition_handler_lambda_role.name
}