...
resource "aws_iam_policy" "soil_moisture_task_planner_iot_get_thing_shadow_policy" {
...
resource "aws_iam_role_policy_attachment" "soil_moisture_task_planner_lambda_iot_policy_attachment" {
  role       = var.soil_moisture_task_planner_lambda_role_name
  policy_arn = aws_iam_policy.soil_moisture_task_planner_iot_get_thing_shadow_policy.arn
}