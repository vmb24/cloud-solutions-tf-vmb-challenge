...
resource "aws_iam_role_policy_attachment" "air_temperature_task_planner_lambda_iot_policy_attachment" {
  role       = var.air_temperature_data_processing_recommendations_lambda_role_name
  policy_arn = aws_iam_policy.air_temperature_processing_data_iot_get_thing_shadow_policy.arn
}