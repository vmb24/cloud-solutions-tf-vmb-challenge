...
resource "aws_iam_role" "soil_moisture_task_planner_lambda_role" {
  name = "soil_moisture_task_planner_lambda"
...
resource "aws_iam_role_policy" "soil_moisture_task_planner_lambda_policy" {
  name = "soil_task_planner_lambda_policy"
  role = aws_iam_role.soil_moisture_task_planner_lambda_role.id
...
resource "aws_iam_role_policy_attachment" "soil_moisture_task_planner_lambda_policy" {
  role       = aws_iam_role.soil_moisture_task_planner_lambda_role.name
