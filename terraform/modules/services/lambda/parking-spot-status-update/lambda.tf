...
resource "aws_lambda_function" "parking_spot_status_update" {
  function_name    = "parking_spot_status_update"
  role             = var.parking_spot_status_update_lambda_role_arn
  handler          = "parking_spot_status_update.lambda_handler"
  runtime          = "python3.9"
