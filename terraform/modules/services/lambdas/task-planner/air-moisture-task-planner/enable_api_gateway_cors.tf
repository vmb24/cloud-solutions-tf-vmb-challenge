...
resource "aws_api_gateway_method" "air_moisture_options_method" {
  for_each = {
    "air_moisture_task_plan" = aws_api_gateway_resource.air_moisture_task_plan.id,
...
resource "aws_api_gateway_integration" "options_integration" {
  for_each = aws_api_gateway_method.air_moisture_options_method
