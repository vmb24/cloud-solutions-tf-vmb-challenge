...
resource "aws_api_gateway_method" "brightness_options_method" {
  for_each = {
    "brightness_task_plan" = aws_api_gateway_resource.brightness_task_plan.id,
...
resource "aws_api_gateway_integration" "options_integration" {
  for_each = aws_api_gateway_method.brightness_options_method
