...
resource "aws_lambda_function" "dynamic_personalization_handler" {
  function_name    = "dynamic_personalization_handler"
  role             = var.agrix_interaction_lambdas_roles_iam_arn
  handler          = "dynamic_personalization_handler.lambda_handler"
  runtime          = "python3.9"
