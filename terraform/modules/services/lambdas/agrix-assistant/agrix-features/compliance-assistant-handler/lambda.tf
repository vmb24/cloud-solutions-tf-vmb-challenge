...
resource "aws_lambda_function" "compliance_assistant_handler" {
  function_name    = "compliance_assistant_handler"
  role             = var.agrix_interaction_lambdas_roles_iam_arn
  handler          = "compliance_assistant_handler.lambda_handler"
  runtime          = "python3.9"
